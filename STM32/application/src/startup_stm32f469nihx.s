...
/* --------------------------------------------------------------------------
   * NEW RUNTIME FIX: Set VTOR to Application space BEFORE SystemInit
   * This ensures any early system handlers look at the right vectors.
   * -------------------------------------------------------------------------- */
  ldr     r0, =0xE000ED08           /* SCB->VTOR Address register */
  ldr     r1, =0x08008400           /* Your Application Start Address (Memory::APP_START_ADDR) */
  str     r1, [r0]
  dsb
  isb
